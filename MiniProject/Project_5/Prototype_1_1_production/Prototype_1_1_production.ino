...
LiquidCrystal_I2C lcd(0x20, 16, 2);  // 0x20 for Proteus 0x27 for Real LCD
...
void measureVoltage() {
  ...
  float voltageIn = voltageOut * 5.69;
...
void measureCurrent() {
  ...
  float calibrationFactor = 0.775;  // Calibration factor to adjust the reading
...
void measureFrequency() {
  ...
  lcd.print("FREQ: ");
  if (frequency > 1000) {
    lcd.print(((float)frequency / 1000.0), 1);
  }
  else {
